...
\caption{Coverage comparison with recent EEG emotion recognition reviews/surveys. The proposed review (Paper~5) provides end-to-end coverage across theoretical, methodological, and evaluation dimensions.}
\label{tab:coverage_comparison}

\resizebox{\textwidth}{!}{%
\begin{tabular}{p{0.28\textwidth} c c c c c c c}
\toprule
\textbf{Paper} &
\textbf{Emotion-Theory} &
\textbf{Subject-Dependent} &
\textbf{Subject-Independent} &
\textbf{Acquisition} &
\textbf{Signal Proc.} &
\textbf{Model Taxonomy} &
\textbf{Eval \& Bench.} \\
\midrule

Jafari \textit{et al.} (2023) \cite{jafari2023dlreview} &
 &  &  &
 & $\checkmark$ & $\checkmark$ & $\checkmark$ \\

Wang \textit{et al.} (2024) \cite{wang2024researchprogress} &
$\checkmark$ & $\checkmark$ & $\checkmark$ &
 & $\checkmark$ & $\checkmark$ & $\checkmark$ \\

Ma \textit{et al.} (2024) \cite{ma2024peerjreview} &
 & $\checkmark$ & $\checkmark$ &
 & $\checkmark$ & $\checkmark$ & $\checkmark$ \\

Erat \textit{et al.} (2024) \cite{erat2024mta} &
 &  &  &
 & $\checkmark$ & $\checkmark$ & $\checkmark$ \\

Chen \textit{et al.} (2025) \cite{chen2025asocreview} &
 &  &  &
 & $\checkmark$ & $\checkmark$ & $\checkmark$ \\

Geng \textit{et al.} (2025) \cite{geng2025dlreview} &
 & $\checkmark$ & $\checkmark$ &
 & $\checkmark$ & $\checkmark$ & $\checkmark$ \\
...
\begin{figure}
    \centering
    \includegraphics[width=0.35\linewidth]{pictures/Modalities.jpg}
    \caption{Modalities}
